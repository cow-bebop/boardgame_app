...
//----------------------------------
// カレントページ
$currentPageNum = (!empty($_GET['p'])) ? (int)($_GET['p']) : 1; //デフォルトは１ページめ
    ...
    <div id="contents" class="site-width">
      ...
      <form class="">
        <div class="index-form">
          <div class="index-form-sort">
            <h2 class="title">カテゴリー</h2>
            <div class="selectbox">
              <span class="icn_select"></span>
              <select class="index-form-select" name="c_id" id="">
          ...
          <div class="index-form-sort">
            <h2 class="title">表示順</h2>
              <div class="selectbox">
                <span class="icn_select"></span>
                <select class="index-form-select" name="sort">
